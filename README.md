...
> [!CAUTION]
> - SD 卡接口无 ESD 防护，热插拔存在硬件风险。
> - 电源接口无防反接保护；电源座正面朝上时，左侧为正极，反接会损坏硬件。
> - 洗板水及其他清洗溶剂会损坏机械轴体。
> - 锂电池最低供电电压为 2.6 V。
...
按键矩阵的实际物理布局如下。表内元件号下方为对应的矩阵信号。

编码器按键：

| 主选编码器 | 次选编码器 |
| --- | --- |
| **KEY1**<br>`KEY3_IN × H2`<br>OK | **KEY2**<br>`KEY3_IN × H1`<br>BACK |

物理按键布局：

| 左纵 | 中央 1 | 中央 2 | 中央 3 | 中央 4 | 右纵 |
| --- | --- | --- | --- | --- | --- |
| **SW25**<br>`KEY3_IN × H3` | **SW1**<br>`L1 × H2` | **SW2**<br>`L2 × H2` | **SW3**<br>`L3 × H2` | **SW4**<br>`L4 × H2` | **SW21**<br>`L5 × H1` |
| **SW26**<br>`KEY3_IN × H4` | **SW5**<br>`L1 × H3` | **SW6**<br>`L2 × H3` | **SW7**<br>`L3 × H3` | **SW8**<br>`L4 × H3` | **SW22**<br>`L5 × H2` |
| **SW27**<br>`KEY3_IN × H5` | **SW9**<br>`L1 × H4` | **SW10**<br>`L2 × H4` | **SW11**<br>`L3 × H4` | **SW12**<br>`L4 × H4` | **SW23**<br>`L5 × H3` |
| **SW28**<br>`KEY3_IN × H6` | **SW13**<br>`L1 × H5` | **SW14**<br>`L2 × H5` | **SW15**<br>`L3 × H5` | **SW16**<br>`L4 × H5` | **SW24**<br>`L5 × H4` |
|  | **SW17**<br>`L1 × H6` | **SW18**<br>`L2 × H6` | **SW19**<br>`L3 × H6` | **SW20**<br>`L4 × H6` |  |
