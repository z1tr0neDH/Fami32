# Fami32 desktop simulator
#   make linux    - C/C++ compiler + SDL2
...
$(TARGET_LINUX): $(LINUX_C_OBJECTS) $(LINUX_CXX_OBJECTS)
	@mkdir -p $(@D)
	$(LINUX_CXX) $^ -o $@ $(LINUX_SDL_LIBS) -pthread -lm
	@echo "Built $@"

$(TARGET_WIN): $(WIN_C_OBJECTS) $(WIN_CXX_OBJECTS)
	@mkdir -p $(@D)
	$(WIN_CXX) $^ -o $@ -static -static-libgcc -static-libstdc++ -lwinmm -lgdi32 -luser32 -pthread
	@echo "Built $@"
